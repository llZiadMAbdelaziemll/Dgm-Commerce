          ...
          <div className='row'>
            <div className='col-4'>
              ...
              <div>
                ...
                <a href='tel:+91 8233522' className='mt-3 d-block mb-2 text-white'>
                  65651635133
                </a>
                <a 
                   href='mailto:aaaaszgg@gmail.com'
            ...
            <div className='col-3'>
              ...
              <div className='footer-links d-flex flex-column'>
                ...
                <Link to="/shipping-policy" className='text-white py-2 mb-1'>Snipping Policy</Link>
          ...
          <div className='row'>
            <div className='col-12'>
              <p className='text-center text-white mb-0'>
                &copy; {new Date().getFullYear()} powered by Ziad Mehreb
              </p>
            </div>
          </div>
        </div>
